    ...
    <div class="col-lg-4 col-sm-6">
     ...
     <form method="post" id="form1">
      ...
      <tr>
		...
		<tr>
			<td><img id="blb15" src="<?php echo $ch[16]=='checked'?'img/lighton.png':'img/lightoff.png' ?>" alt="not found" width="30" height="50"></td>
			<td>Light</td>
		...
		<tr>
			<td><img id="blb116" src="<?php echo $ch[17]=='checked'?'img/lighton.png':'img/lightoff.png' ?>" alt="not found" width="30" height="50"></td>
			<td>Water Pump</td>
