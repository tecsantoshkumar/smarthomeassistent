        ...
        <table >
          <tr>
    		...
    		<tr>
    			...
    			<td>Light</td>
    			<td><label class="switch"><input  id="ch1" onchange="fun1(1,'L1')" <?php echo $ch[0]; ?> type="checkbox"><span class="slider round"></span></label></td>
    		</tr>
    		<tr>
    			<td><img id="blb2" src="<?php echo $ch[1]=='checked'?'img/lighton.png':'img/lightoff.png' ?>" alt="not found" width="30" height="50"></td>
    			<td>Fan</td>
    			<td><label class="switch"><input id="ch2" onchange="fun1(2,'L2')" <?php echo $ch[1]; ?> type="checkbox"><span class="slider round"></span></label></td>
    		</tr>
    		<tr>
    			<td><img id="blb3" src="<?php echo $ch[2]=='checked'?'img/lighton.png':'img/lightoff.png' ?>" alt="not found" width="30" height="50"></td>
    			<td>AC</td>
    			<td><label class="switch"><input id="ch3" onchange="fun1(3,'L3')" <?php echo $ch[2]; ?> type="checkbox"><span class="slider round"></span></label></td>
    		</tr>
    		<tr>
    			<td><img id="blb4" src="<?php echo $ch[3]=='checked'?'img/lighton.png':'img/lightoff.png' ?>" alt="not found" width="30" height="50"></td>
    			<td>Projecter</td>
    			<td><label class="switch"><input id="ch4" onchange="fun1(4,'L4')" <?php echo $ch[3]; ?> type="checkbox"><span class="slider round"></span></label></td>
    		</tr>
    	</table>
</from>
	</div>
