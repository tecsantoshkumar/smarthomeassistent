    ...
    <div class="col-lg-4 col-sm-6">
     ...
     <form method="post" id="form1">
      ...
      <tr>
		...
		<tr>
			<td><img id="blb15" src="<?php echo $ch[14]=='checked'?'img/lighton.png':'img/lightoff.png' ?>" alt="not found" width="30" height="50"></td>
			<td>Light</td>
			<td><label class="switch"><input  id="ch15" onchange="fun1(15,'L15')" <?php echo $ch[14]; ?> type="checkbox"><span class="slider round"></span></label></td>
		</tr>
		<tr>
			<td><img id="blb16" src="<?php echo $ch[15]=='checked'?'img/lighton.png':'img/lightoff.png' ?>" alt="not found" width="30" height="50"></td>
			<td>Heater</td>
			<td><label class="switch"><input id="ch16" onchange="fun1(16,'L16')" <?php echo $ch[15]; ?> type="checkbox"><span class="slider round"></span></label></td>
		</tr>
		<tr>
			<td><img id="blb17" src="<?php echo $ch[16]=='checked'?'img/lighton.png':'img/lightoff.png' ?>" alt="not found" width="30" height="50"></td>
			<td>Water Pump</td>
			<td><label class="switch"><input id="ch17" onchange="fun1(17,'L17')" <?php echo $ch[16]; ?> type="checkbox"><span class="slider round"></span></label></td>
		</tr>
		<tr>
			<td><img id="blb18" src="<?php echo $ch[17]=='checked'?'img/lighton.png':'img/lightoff.png' ?>" alt="not found" width="30" height="50"></td>
			<td>Exast Fan</td>
			<td><label class="switch"><input id="ch18" onchange="fun1(18,'L18')" <?php echo $ch[17]; ?> type="checkbox"><span class="slider round"></span></label></td>
		</tr>
	</table>
</from>
	</div>
